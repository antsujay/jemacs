...
export function installCoreCommands(editor: Editor): Evaluator {
  ...
  editor.command("self-insert-command", ({ buffer, editor, args, prefixArgument }) => {
  ...
  editor.command("delete-backward-char", ({ buffer, prefixArgument }) => repeat(prefixArgument, () => buffer.deleteBackward(), () => buffer.deleteForward()), "Delete the character before point.")
